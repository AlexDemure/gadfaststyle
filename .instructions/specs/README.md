...
- Для backend используй `.specs/src/.../spec.md`.
- Для tests используй `.specs/tests/.../spec.md`.
...
```md
# .specs/src/application/usecases/accounts/update/spec.md

## Статус

- created_at: 2026-03-31
- system_analyst_updated_at: 2026-03-31
...
```md
# .specs/tests/test_integrations/test_entrypoints/test_http/test_public/test_accounts/update/spec.md
